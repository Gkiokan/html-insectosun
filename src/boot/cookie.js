...
function CookieConsent(props) {
   ...
   self.props = {
       ...
       defaultLang: "de", // default language, if the `lang` is not available as translation in `cookie-consent-content`
   ...
   function renderModal() {
    ...
    //    console.log({ modalContent: self.modalContent})
       if (getCookie(self.props.cookieName) === undefined && self.props.autoShowModal) {
           showDialog(self.modalContent)
       }
   }
   ...
   function showDialog(inner) {
    //    documentReady(function () {
           ...
           if (!self.modal) {
               ...
               self.modal.innerHTML = self.modalContent ?? inner
               document.body.append(self.modal)

               console.log({ modal: self.modal, modalContent: self.modalContent, inner })
